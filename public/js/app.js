...
var shakes = storage.getItem('shakes') || 0;
...
$(document).on("ready", function() {
    ...
    app.utils.templates.load(["LoginView", "HomeView", "RegisterView", "MessagesView", "ActivityMonitorView", "VotingView", "AboutView", "ScheduleView"],
        function() {
            app.router = new app.routers.AppRouter();
