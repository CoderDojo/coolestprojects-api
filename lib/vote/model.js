...
module.exports = {
  ...
  status: function(vote, success, error) {
        db.query('select distinct title, count(*) from project, vote where projectid=project.id group by 1 order by 2 desc limit 15', 
